...
{
	img->ceil_texture_paths = "assets/textures/walls/ceil/ceil.xpm";
	...
	img->floor_texture_paths = "assets/textures/walls/floor/floor0.xpm";
...
{
	preload->logo[0].path = "assets/textures/ui/odyssey/odyssey-1.xpm";
	preload->logo[1].path = "assets/textures/ui/odyssey/odyssey-2.xpm";
	preload->logo[2].path = "assets/textures/ui/odyssey/odyssey-3.xpm";
	preload->logo[3].path = "assets/textures/ui/odyssey/odyssey-4.xpm";
	preload->logo[4].path = "assets/textures/ui/odyssey/odyssey-5.xpm";
	preload->logo[5].path = "assets/textures/ui/odyssey/odyssey-6.xpm";
	preload->logo[6].path = "assets/textures/ui/odyssey/odyssey-7.xpm";
	preload->logo[7].path = "assets/textures/ui/odyssey/odyssey-8.xpm";
	preload->logo[8].path = "assets/textures/ui/odyssey/odyssey-9.xpm";
	preload->logo[9].path = "assets/textures/ui/odyssey/odyssey-10.xpm";
	preload->logo[10].path = "assets/textures/ui/odyssey/odyssey-11.xpm";
	preload->logo[11].path = "assets/textures/ui/odyssey/odyssey-12.xpm";
	preload->logo[12].path = "assets/textures/ui/odyssey/odyssey-13.xpm";
	preload->background.path = "assets/textures/ui/background.xpm";
	return (preload);
}
